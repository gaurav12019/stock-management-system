...
$sql = "SELECT * FROM `new` ORDER BY `slno`";
...
<body>
  ...
  <h3><b><u>NEW STOCK RECORD&nbsp<input type="text" id="myInput" onkeyup="myFunction()" placeholder="🔍Search your data..." title="Type in a name"></u></b></h3>
